# Cursus 4: De Floorbook-benadering onder de knie krijgen
...
## **Module 2: Complexe dialogen organiseren**

### **Module Overview**
| Element | Inhoud |
|---------|---------|
| **Core Focus** | Faciliteren van onderzoek & dialoog |
| **Learning Goal** | Het faciliteren van verfijnde "Mogelijkheidsdenken" gesprekken die het begrip verdiepen |

### **Module Content Structure**
| Component | Inhoud |
|-----------|---------|
| **Introduction** | Leer gesprekken te faciliteren waarin kinderen op complexe manieren op elkaars ideeën voortbouwen |
| **Theory** | **Video provided:** Masterclass van 18 minuten in het faciliteren van meerlagige groepsgesprekken. **Handout included:** Geavanceerde vraagtechnieken en gespreksleidraden. • **Key Concepts:** Mogelijkheidsdenken, Samen betekenis maken, Gespreksbegeleiding, Samen denken, Dialogisch onderzoek |
| **Interactive Exercise** | Oefen complexe groepsgesprekken met behulp van videoscenario's |
| **Practical** | Leid een uitgebreid onderzoeksgesprek en analyseer de denkpatronen die ontstaan |
| **Child Voice** | **Audio scenarios:** Kinderen zijn bezig met verfijnd samenwerkend denken |
| **Practitioner Voice** | **Audio conversations:** Expert facilitators delen hun technieken om complexe dialoog te ondersteunen |
| **Conclusion** | **What you'll gain:** Vaardigheden op expertniveau die verfijnd samenwerkend denken en complexe dialoog mogelijk maken. **Expected outcome:** Je zult gesprekken orkestreren waarin kinderen samen diepgaande inzichten verwerven en hun vermogen om samen betekenis te geven ontwikkelen. Je vaardigheden worden gevraagd door collega's en je wordt een mentor voor anderen die hun gespreksvaardigheden ontwikkelen |

---

## **Module 3: Vloerboeken als levend leerplan**

### **Module Overview**
| Element | Inhoud |
|---------|---------|
| **Core Focus** | De kunst van samenwerkend documenteren |
| **Learning Goal** | Floorbooks gebruiken als dynamische hulpmiddelen voor leerplanplanning en beoordeling | |

### **Module Content Structure**
| Component | Inhoud |
|-----------|---------|
| **Introduction** | Verander Floorbooks van documentatiehulpmiddelen in leerplangereedschappen |
| **Theory** | **Video provided:** Demonstratie van 17 minuten over hoe Floorbooks de dagelijkse planning en beoordeling kunnen sturen. **Handout included:** Sjablonen voor het in kaart brengen van het leerplan en handleidingen voor het integreren van beoordelingen. • **Key Concepts:** Levend leerplan, Opkomende planning, Beoordeling door documentatie, Verantwoording van leerplannen, Integratie van normen |
| **Interactive Exercise** | Breng leerplannormen in kaart met lopende onderzoeken in het Floorbook |
| **Practical** | Gebruik uw Floorbooks om de leerervaringen van de volgende week te plannen en de vooruitgang van de kinderen te beoordelen |
| **Child Voice** | **Audio scenarios:** Kinderen nemen verantwoordelijkheid voor hun leerproces door middel van Floorbook reflectie |
| **Practitioner Voice** | **Audio conversations:** Praktijkassistenten leggen uit hoe Floorbooks traditionele planningsmethodes vervangen |
| **Conclusion** | **What you'll gain:** Gevorderde vaardigheden in het gebruik van documentatie als een levend plannings- en beoordelingsinstrument. **Expected outcome:** Uw Floorbooks zullen een uitgebreide dekking van het curriculum laten zien, terwijl de focus op het kind gericht blijft. U creëert documentatiesystemen die voldoen aan de eisen voor verantwoording en tegelijkertijd onderzoeksprincipes respecteren. U wordt een model voor anderen die een balans zoeken tussen standaarden en authentiek leren |
